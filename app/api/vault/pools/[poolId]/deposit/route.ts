...
export async function POST(
  ...
  try {
    ...
    const transactionData = await VaultApiService.prepareDepositTransaction(poolId, walletAddress, amount, tokenAddress, networkId);
    ...
    console.error('Prepare deposit transaction error:', error.message);
